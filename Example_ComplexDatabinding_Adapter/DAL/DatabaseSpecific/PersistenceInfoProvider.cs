...
// Code is generated on: woensdag 14 maart 2012 14:30:30
...
namespace Northwind.DAL.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void InitAlphabeticalListOfProductTypedViewMappings()
		{
			...
			this.AddElementFieldMapping( "AlphabeticalListOfProductTypedView", "ProductId", "ProductID", false, "Int", 0, 0, 10,false, string.Empty, null, typeof(System.Int32), 0 );
			...
			this.AddElementFieldMapping( "AlphabeticalListOfProductTypedView", "SupplierId", "SupplierID", false, "Int", 0, 0, 10,false, string.Empty, null, typeof(System.Int32), 2 );
			this.AddElementFieldMapping( "AlphabeticalListOfProductTypedView", "CategoryId", "CategoryID", false, "Int", 0, 0, 10,false, string.Empty, null, typeof(System.Int32), 3 );
			...
			this.AddElementFieldMapping( "AlphabeticalListOfProductTypedView", "UnitPrice", "UnitPrice", false, "Money", 0, 4, 19,false, string.Empty, null, typeof(System.Decimal), 5 );
			this.AddElementFieldMapping( "AlphabeticalListOfProductTypedView", "UnitsInStock", "UnitsInStock", false, "SmallInt", 0, 0, 5,false, string.Empty, null, typeof(System.Int16), 6 );
			this.AddElementFieldMapping( "AlphabeticalListOfProductTypedView", "UnitsOnOrder", "UnitsOnOrder", false, "SmallInt", 0, 0, 5,false, string.Empty, null, typeof(System.Int16), 7 );
			this.AddElementFieldMapping( "AlphabeticalListOfProductTypedView", "ReorderLevel", "ReorderLevel", false, "SmallInt", 0, 0, 5,false, string.Empty, null, typeof(System.Int16), 8 );
		...
		private void InitInvoiceTypedViewMappings()
		{
			...
			this.AddElementFieldMapping( "InvoiceTypedView", "OrderId", "OrderID", false, "Int", 0, 0, 10,false, string.Empty, null, typeof(System.Int32), 14 );
			...
			this.AddElementFieldMapping( "InvoiceTypedView", "ProductId", "ProductID", false, "Int", 0, 0, 10,false, string.Empty, null, typeof(System.Int32), 19 );
			...
			this.AddElementFieldMapping( "InvoiceTypedView", "UnitPrice", "UnitPrice", false, "Money", 0, 4, 19,false, string.Empty, null, typeof(System.Decimal), 21 );
			this.AddElementFieldMapping( "InvoiceTypedView", "Quantity", "Quantity", false, "SmallInt", 0, 0, 5,false, string.Empty, null, typeof(System.Int16), 22 );
			this.AddElementFieldMapping( "InvoiceTypedView", "Discount", "Discount", false, "Real", 0, 0, 24,false, string.Empty, null, typeof(System.Single), 23 );
			this.AddElementFieldMapping( "InvoiceTypedView", "ExtendedPrice", "ExtendedPrice", false, "Money", 0, 4, 19,false, string.Empty, null, typeof(System.Decimal), 24 );
			this.AddElementFieldMapping( "InvoiceTypedView", "Freight", "Freight", false, "Money", 0, 4, 19,false, string.Empty, null, typeof(System.Decimal), 25 );
		}
		/// <summary>Inits View's mappings</summary>
