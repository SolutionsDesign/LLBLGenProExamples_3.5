...
namespace Northwind.DAL.TypedViewClasses
{
	...
	public partial class InvoiceTypedView : TypedViewBase<InvoiceRow>, ITypedView2
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void InitClass()
		{
			...
			_fields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.InvoiceTypedView);
