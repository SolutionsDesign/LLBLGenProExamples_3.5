...
// Code is generated on: woensdag 14 maart 2012 14:30:29
...
namespace Northwind.DAL.HelperClasses
{
	...
	internal class FieldInfoProviderCore : FieldInfoProviderBase
	{
		...
		private void InitAlphabeticalListOfProductTypedViewInfos()
		{
			...
			this.AddElementFieldInfo("AlphabeticalListOfProductTypedView", "SupplierId", typeof(System.Int32), false, false, true, false, (int)AlphabeticalListOfProductFieldIndex.SupplierId, 0, 0, 10);
			this.AddElementFieldInfo("AlphabeticalListOfProductTypedView", "CategoryId", typeof(System.Int32), false, false, true, false, (int)AlphabeticalListOfProductFieldIndex.CategoryId, 0, 0, 10);
			...
			this.AddElementFieldInfo("AlphabeticalListOfProductTypedView", "UnitPrice", typeof(System.Decimal), false, false, true, false, (int)AlphabeticalListOfProductFieldIndex.UnitPrice, 0, 4, 19);
			this.AddElementFieldInfo("AlphabeticalListOfProductTypedView", "UnitsInStock", typeof(System.Int16), false, false, true, false, (int)AlphabeticalListOfProductFieldIndex.UnitsInStock, 0, 0, 5);
			this.AddElementFieldInfo("AlphabeticalListOfProductTypedView", "UnitsOnOrder", typeof(System.Int16), false, false, true, false, (int)AlphabeticalListOfProductFieldIndex.UnitsOnOrder, 0, 0, 5);
			this.AddElementFieldInfo("AlphabeticalListOfProductTypedView", "ReorderLevel", typeof(System.Int16), false, false, true, false, (int)AlphabeticalListOfProductFieldIndex.ReorderLevel, 0, 0, 5);
		...
		private void InitInvoiceTypedViewInfos()
		{
			...
			this.AddElementFieldInfo("InvoiceTypedView", "OrderDate", typeof(System.DateTime), false, false, true, false, (int)InvoiceFieldIndex.OrderDate, 0, 0, 0);
			this.AddElementFieldInfo("InvoiceTypedView", "RequiredDate", typeof(System.DateTime), false, false, true, false, (int)InvoiceFieldIndex.RequiredDate, 0, 0, 0);
			this.AddElementFieldInfo("InvoiceTypedView", "ShippedDate", typeof(System.DateTime), false, false, true, false, (int)InvoiceFieldIndex.ShippedDate, 0, 0, 0);
			...
			this.AddElementFieldInfo("InvoiceTypedView", "ExtendedPrice", typeof(System.Decimal), false, false, true, false, (int)InvoiceFieldIndex.ExtendedPrice, 0, 4, 19);
			this.AddElementFieldInfo("InvoiceTypedView", "Freight", typeof(System.Decimal), false, false, true, false, (int)InvoiceFieldIndex.Freight, 0, 4, 19);
		}
		/// <summary>Inits View's FieldInfo objects</summary>
