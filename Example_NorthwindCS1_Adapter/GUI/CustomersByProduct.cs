...
namespace Northwind.GUI
{
	...
	public class CustomersByProduct : System.Windows.Forms.Form
	{
		...
		private RelationPredicateBucket			_filterBucket;
		...
		public CustomersByProduct()
		{
			...
			_filterBucket.Relations.Add(CustomerEntity.Relations.OrderEntityUsingCustomerId);
			_filterBucket.Relations.Add(OrderEntity.Relations.OrderDetailEntityUsingOrderId);
			_filterBucket.Relations.Add(OrderDetailEntity.Relations.ProductEntityUsingProductId); // ... and end with the entity you want to use in your filter...
			...
			// add the filter to the bucket.
			_filterBucket.PredicateExpression.Add(_productFilter);
			...
			adapter.FetchEntityCollection(products, null, 0, productSorter);
		...
		private void productSelectComboBox_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			DataAccessAdapter adapter = new DataAccessAdapter();
			adapter.FetchEntityCollection(customers, _filterBucket, 0, _customerSorter);
