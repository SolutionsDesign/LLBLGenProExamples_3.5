...
namespace Northwind.GUI
{
	...
	public class CustomerManager : System.Windows.Forms.Form
	{
		...
		private ArrayList			_visitedOrderDetails;
		#endregion
		...
		private void BindOrders()
		{
			...
			{
				((OrderDetailCollection)_visitedOrderDetails[i]).ListChanged-=new ListChangedEventHandler(CurrentOrderDetails_ListChanged);
			}
			...
			if(_currentCustomer.Orders.Count>0)
			{
				...
				if(!_visitedOrderDetails.Contains(_currentCustomer.Orders[ordersDataGrid.CurrentRowIndex].OrderDetails))
				{
					...
					// add eventhandler
					_currentCustomer.Orders[ordersDataGrid.CurrentRowIndex].OrderDetails.ListChanged+=new ListChangedEventHandler(CurrentOrderDetails_ListChanged);
				}
		...
		private void InitializeComponent()
		{
			...
			this.saveCustomerButton.Location = new System.Drawing.Point(483, 180);
			...
			this.postalCodeTextBox.Location = new System.Drawing.Point(492, 129);
			...
			this.contactNameTextBox.Size = new System.Drawing.Size(249, 20);
			...
			this.groupBox2.Size = new System.Drawing.Size(588, 375);
			...
			this.ordersDataGrid.Size = new System.Drawing.Size(582, 164);
			...
			this.splitter1.Size = new System.Drawing.Size(582, 6);
			...
			this.groupBox3.Size = new System.Drawing.Size(582, 144);
			...
			this.orderDetailsDataGrid.Size = new System.Drawing.Size(576, 125);
			...
			this.refreshOrdersButton.Location = new System.Drawing.Point(357, 9);
			...
			this.saveOrdersButton.Location = new System.Drawing.Point(468, 9);
		...
		private void saveOrdersButton_Click(object sender, System.EventArgs e)
		{
			...
			// use recursive save logic.
			_currentCustomer.Save(true);
			MessageBox.Show(this, "Save action performed.", "Save result", MessageBoxButtons.OK, MessageBoxIcon.Information);
			saveOrdersButton.Enabled=false;
		...
		private void removeOrderButton_Click(object sender, System.EventArgs e)
		{
			...
			OrderEntity currentOrder = _currentCustomer.Orders[ordersDataGrid.CurrentRowIndex];
