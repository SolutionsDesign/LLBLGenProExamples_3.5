...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private Northwind.DAL.CollectionClasses.OrderDetailCollection	_orderDetails;
		...
		{
			_orderDetails = (Northwind.DAL.CollectionClasses.OrderDetailCollection)info.GetValue("_orderDetails", typeof(Northwind.DAL.CollectionClasses.OrderDetailCollection));
		...
		public Northwind.DAL.CollectionClasses.OrderDetailCollection GetMultiOrderDetails(bool forceFetch)
		{
		...
		/// <returns>Filled collection with all related entities of type 'OrderDetailEntity'</returns>
		public Northwind.DAL.CollectionClasses.OrderDetailCollection GetMultiOrderDetails(bool forceFetch, IPredicateExpression filter)
		{
		...
		public Northwind.DAL.CollectionClasses.OrderDetailCollection GetMultiOrderDetails(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public virtual Northwind.DAL.CollectionClasses.OrderDetailCollection GetMultiOrderDetails(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
		...
		private void InitClassMembers()
		{
			...
			_orderDetails = new Northwind.DAL.CollectionClasses.OrderDetailCollection();
		...
		private void SetupSyncCustomer(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", Northwind.DAL.RelationClasses.StaticOrderRelations.CustomerEntityUsingCustomerIdStatic, true, ref _alreadyFetchedCustomer, new string[] {  } );
			}
		}
		...
		private void SetupSyncEmployee(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _employee, new PropertyChangedEventHandler( OnEmployeePropertyChanged ), "Employee", Northwind.DAL.RelationClasses.StaticOrderRelations.EmployeeEntityUsingEmployeeIdStatic, true, ref _alreadyFetchedEmployee, new string[] {  } );
			}
		}
		...
		private void SetupSyncShipper(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _shipper, new PropertyChangedEventHandler( OnShipperPropertyChanged ), "Shipper", Northwind.DAL.RelationClasses.StaticOrderRelations.ShipperEntityUsingShipViaStatic, true, ref _alreadyFetchedShipper, new string[] {  } );
			}
		}
		...
		{
			get { return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.OrderDetailCollection(), (IEntityRelation)GetRelationsForField("OrderDetails")[0], (int)Northwind.DAL.EntityType.OrderEntity, (int)Northwind.DAL.EntityType.OrderDetailEntity, 0, null, null, null, "OrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.CustomerCollection(), (IEntityRelation)GetRelationsForField("Customer")[0], (int)Northwind.DAL.EntityType.OrderEntity, (int)Northwind.DAL.EntityType.CustomerEntity, 0, null, null, null, "Customer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.EmployeeCollection(), (IEntityRelation)GetRelationsForField("Employee")[0], (int)Northwind.DAL.EntityType.OrderEntity, (int)Northwind.DAL.EntityType.EmployeeEntity, 0, null, null, null, "Employee", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.ShipperCollection(), (IEntityRelation)GetRelationsForField("Shipper")[0], (int)Northwind.DAL.EntityType.OrderEntity, (int)Northwind.DAL.EntityType.ShipperEntity, 0, null, null, null, "Shipper", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		public virtual Northwind.DAL.CollectionClasses.OrderDetailCollection OrderDetails
		{
