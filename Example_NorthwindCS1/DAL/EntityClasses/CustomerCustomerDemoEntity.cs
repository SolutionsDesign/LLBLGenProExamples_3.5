		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncCustomer(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _customer, new PropertyChangedEventHandler( OnCustomerPropertyChanged ), "Customer", Northwind.DAL.RelationClasses.StaticCustomerCustomerDemoRelations.CustomerEntityUsingCustomerIdStatic, true, ref _alreadyFetchedCustomer, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.CustomerCollection(), (IEntityRelation)GetRelationsForField("Customer")[0], (int)Northwind.DAL.EntityType.CustomerCustomerDemoEntity, (int)Northwind.DAL.EntityType.CustomerEntity, 0, null, null, null, "Customer", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.CustomerDemographicCollection(), (IEntityRelation)GetRelationsForField("CustomerDemographic")[0], (int)Northwind.DAL.EntityType.CustomerCustomerDemoEntity, (int)Northwind.DAL.EntityType.CustomerDemographicEntity, 0, null, null, null, "CustomerDemographic", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
