		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncRegion(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _region, new PropertyChangedEventHandler( OnRegionPropertyChanged ), "Region", Northwind.DAL.RelationClasses.StaticTerritoryRelations.RegionEntityUsingRegionIdStatic, true, ref _alreadyFetchedRegion, new string[] {  } );
			}
		}
		...
		{
			get { return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.EmployeeTerritoryCollection(), (IEntityRelation)GetRelationsForField("EmployeeTerritories")[0], (int)Northwind.DAL.EntityType.TerritoryEntity, (int)Northwind.DAL.EntityType.EmployeeTerritoryEntity, 0, null, null, null, "EmployeeTerritories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.RegionCollection(), (IEntityRelation)GetRelationsForField("Region")[0], (int)Northwind.DAL.EntityType.TerritoryEntity, (int)Northwind.DAL.EntityType.RegionEntity, 0, null, null, null, "Region", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
