******************************************************************
LLBLGen Pro WCF example READ-ME FILE
******************************************************************

Example Description
-------------------
- A VS.NET Solution that Shows how to implement a WCF solution with LLBLGenPro Adapter TemplateSet.
...
-----------------------------------
1. Use Visual Studio (solution file is in format vs.net 2008) to open and build the solution found in the root folder: "\SD.LLBLGen.Pro.Examples.WCF.sln"
