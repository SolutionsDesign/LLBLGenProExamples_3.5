...
namespace SD.LLBLGen.Pro.Examples.WCF.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the Categories entity</summary>
		public EntityQuery<CategoriesEntity> Categories
		{
			get { return Create<CategoriesEntity>(); }
		}
		...
		/// <summary>Creates and returns a new EntityQuery for the Products entity</summary>
		public EntityQuery<ProductsEntity> Products
		{
			get { return Create<ProductsEntity>(); }
		}
