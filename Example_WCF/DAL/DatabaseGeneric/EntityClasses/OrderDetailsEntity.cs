...
namespace SD.LLBLGen.Pro.Examples.WCF.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private ProductsEntity _products;
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				case "Orders":
					...
					break;
				case "Products":
					this.Products = (ProductsEntity)entity;
					break;
				default:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "Orders":
					...
					break;
				case "Products":
					toReturn.Add(Relations.ProductsEntityUsingProductId);
					break;
				default:
					break;				
			}
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entity of type 'Products' to this entity.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoProducts()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ProductsFields.ProductId, null, ComparisonOperator.Equal, this.ProductId));
			return bucket;
		}
		...
		private void SetupSyncProducts(IEntityCore relatedEntity)
		{
			if(_products!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _products, new PropertyChangedEventHandler( OnProductsPropertyChanged ), "Products", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrderDetailsRelations.ProductsEntityUsingProductIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(OrdersEntityFactory))),	(IEntityRelation)GetRelationsForField("Orders")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderDetailsEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrdersEntity, 0, null, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductsEntityFactory))),	(IEntityRelation)GetRelationsForField("Products")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrderDetailsEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductsEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> Gets / sets related entity of type 'ProductsEntity' which has to be set using a fetch action earlier. If no related entity is set for this property, null is returned..<br/><br/></summary>
		[Browsable(true)]
		public virtual ProductsEntity Products
		{
