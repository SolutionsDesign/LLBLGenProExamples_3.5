		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncEmployees(IEntityCore relatedEntity)
		{
			if(_employees!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employees, new PropertyChangedEventHandler( OnEmployeesPropertyChanged ), "Employees", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticEmployeesRelations.EmployeesEntityUsingEmployeeIdReportsToStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<OrdersEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrdersEntityFactory))), (IEntityRelation)GetRelationsForField("Orders")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeesEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrdersEntity, 0, null, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCustomersCollectionViaOrders
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CustomersEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomersEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeesEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CustomersEntity, 0, null, null, GetRelationsForField("CustomersCollectionViaOrders"), null, "CustomersCollectionViaOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeesEntity; }
		}
