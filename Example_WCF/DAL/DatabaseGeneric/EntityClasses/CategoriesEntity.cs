...
namespace SD.LLBLGen.Pro.Examples.WCF.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Categories'.<br/><br/></summary>
	[Serializable]
	public partial class CategoriesEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Products":
					toReturn.Add(Relations.ProductsEntityUsingCategoryId);
					break;
				default:
					break;				
			}
		...
		public virtual IRelationPredicateBucket GetRelationInfoProducts()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ProductsFields.CategoryId, null, ComparisonOperator.Equal, this.CategoryId));
			return bucket;
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<ProductsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductsEntityFactory))), (IEntityRelation)GetRelationsForField("Products")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CategoriesEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductsEntity, 0, null, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		/// <summary> The CategoryId property of the Entity Categories<br/><br/></summary>
		...
		/// <summary> The CategoryName property of the Entity Categories<br/><br/></summary>
		...
		/// <summary> The Description property of the Entity Categories<br/><br/></summary>
		...
		public virtual System.String Description
		{
			...
			set	{ SetValue((int)CategoriesFieldIndex.Description, value); }
		}

		/// <summary> The Picture property of the Entity Categories<br/><br/></summary>
		...
		public virtual System.Byte[] Picture
		{
			...
			set	{ SetValue((int)CategoriesFieldIndex.Picture, value); }
		}
		...
		{
			get { return GetOrCreateEntityCollection<ProductsEntity, ProductsEntityFactory>("Categories", true, false, ref _products);	}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CategoriesEntity; }
		}
