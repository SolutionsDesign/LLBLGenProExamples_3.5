...
namespace SD.LLBLGen.Pro.Examples.WCF.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<OrdersEntity> _ordersCollectionViaOrderDetails;
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "OrdersCollectionViaOrderDetails":
					...
					this.OrdersCollectionViaOrderDetails.Add((OrdersEntity)entity);
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "OrderDetails":
					...
					break;
				case "OrdersCollectionViaOrderDetails":
					toReturn.Add(Relations.OrderDetailsEntityUsingProductId, "ProductsEntity__", "OrderDetails_", JoinHint.None);
					toReturn.Add(OrderDetailsEntity.Relations.OrdersEntityUsingOrderId, "OrderDetails_", string.Empty, JoinHint.None);
					break;
				default:
					break;				
			}
		...
		public virtual IRelationPredicateBucket GetRelationInfoOrdersCollectionViaOrderDetails()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(ProductsFields.ProductId, null, ComparisonOperator.Equal, this.ProductId, "ProductsEntity__"));
			return bucket;
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._ordersCollectionViaOrderDetails = (EntityCollection<OrdersEntity>) collectionsQueue.Dequeue();
		...
		public static IPrefetchPathElement2 PrefetchPathOrdersCollectionViaOrderDetails
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OrdersEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrdersEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductsEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrdersEntity, 0, null, null, GetRelationsForField("OrdersCollectionViaOrderDetails"), null, "OrdersCollectionViaOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CategoriesEntityFactory))),	(IEntityRelation)GetRelationsForField("Categories")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductsEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CategoriesEntity, 0, null, null, null, null, "Categories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'OrdersEntity' which are related to this entity via a relation of type 'm:n'. If the EntityCollection hasn't been fetched yet, the collection returned will be empty.<br/><br/></summary>
		[TypeContainedAttribute(typeof(OrdersEntity))]
		public virtual EntityCollection<OrdersEntity> OrdersCollectionViaOrderDetails
		{
			get { return GetOrCreateEntityCollection<OrdersEntity, OrdersEntityFactory>("ProductsCollectionViaOrderDetails", false, true, ref _ordersCollectionViaOrderDetails);	}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductsEntity; }
		}
