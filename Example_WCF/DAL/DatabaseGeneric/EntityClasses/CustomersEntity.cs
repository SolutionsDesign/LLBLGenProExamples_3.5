...
namespace SD.LLBLGen.Pro.Examples.WCF.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public static IPrefetchPathElement2 PrefetchPathEmployeesCollectionViaOrders
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<EmployeesEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeesEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CustomersEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeesEntity, 0, null, null, GetRelationsForField("EmployeesCollectionViaOrders"), null, "EmployeesCollectionViaOrders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CustomersEntity; }
		}
