...
namespace SD.LLBLGen.Pro.Examples.WCF.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<ProductsEntity> _productsCollectionViaOrderDetails;
		...
		protected OrdersEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_productsCollectionViaOrderDetails = (EntityCollection<ProductsEntity>)info.GetValue("_productsCollectionViaOrderDetails", typeof(EntityCollection<ProductsEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "ProductsCollectionViaOrderDetails":
					...
					this.ProductsCollectionViaOrderDetails.Add((ProductsEntity)entity);
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "OrderDetails":
					...
					break;
				case "ProductsCollectionViaOrderDetails":
					toReturn.Add(Relations.OrderDetailsEntityUsingOrderId, "OrdersEntity__", "OrderDetails_", JoinHint.None);
					toReturn.Add(OrderDetailsEntity.Relations.ProductsEntityUsingProductId, "OrderDetails_", string.Empty, JoinHint.None);
					break;
				default:
					break;				
			}
		...
		public virtual IRelationPredicateBucket GetRelationInfoProductsCollectionViaOrderDetails()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(OrdersFields.OrderId, null, ComparisonOperator.Equal, this.OrderId, "OrdersEntity__"));
			return bucket;
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._productsCollectionViaOrderDetails = (EntityCollection<ProductsEntity>) collectionsQueue.Dequeue();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _customers, new PropertyChangedEventHandler( OnCustomersPropertyChanged ), "Customers", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrdersRelations.CustomersEntityUsingCustomerIdStatic, true, signalRelatedEntity, "Orders", resetFKFields, new int[] { (int)OrdersFieldIndex.CustomerId } );
			_customers = null;
		}
		...
		private void SetupSyncCustomers(IEntityCore relatedEntity)
		{
			if(_customers!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _customers, new PropertyChangedEventHandler( OnCustomersPropertyChanged ), "Customers", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrdersRelations.CustomersEntityUsingCustomerIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncEmployees(IEntityCore relatedEntity)
		{
			if(_employees!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employees, new PropertyChangedEventHandler( OnEmployeesPropertyChanged ), "Employees", SD.LLBLGen.Pro.Examples.WCF.RelationClasses.StaticOrdersRelations.EmployeesEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathProductsCollectionViaOrderDetails
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ProductsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductsEntityFactory))), intermediateRelation,
					(int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrdersEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.ProductsEntity, 0, null, null, GetRelationsForField("ProductsCollectionViaOrderDetails"), null, "ProductsCollectionViaOrderDetails", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomersEntityFactory))),	(IEntityRelation)GetRelationsForField("Customers")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrdersEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.CustomersEntity, 0, null, null, null, null, "Customers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeesEntityFactory))),	(IEntityRelation)GetRelationsForField("Employees")[0], (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrdersEntity, (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.EmployeesEntity, 0, null, null, null, null, "Employees", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'ProductsEntity' which are related to this entity via a relation of type 'm:n'. If the EntityCollection hasn't been fetched yet, the collection returned will be empty.<br/><br/></summary>
		[TypeContainedAttribute(typeof(ProductsEntity))]
		public virtual EntityCollection<ProductsEntity> ProductsCollectionViaOrderDetails
		{
			get { return GetOrCreateEntityCollection<ProductsEntity, ProductsEntityFactory>("OrdersCollectionViaOrderDetails", false, true, ref _productsCollectionViaOrderDetails);	}
		}
		...
		{ 
			get { return (int)SD.LLBLGen.Pro.Examples.WCF.EntityType.OrdersEntity; }
		}
