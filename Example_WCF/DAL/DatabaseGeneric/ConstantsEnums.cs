...
{
	/// <summary>Index enum to fast-access EntityFields in the IEntityFields collection for the entity: Categories.</summary>
	public enum CategoriesFieldIndex
	{
	...
	/// <summary>Index enum to fast-access EntityFields in the IEntityFields collection for the entity: Products.</summary>
	public enum ProductsFieldIndex
	{
		///<summary>CategoryId. </summary>
		CategoryId,
