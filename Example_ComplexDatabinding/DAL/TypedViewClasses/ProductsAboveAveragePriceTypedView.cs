...
namespace Northwind.DAL.TypedViewClasses
{
	...
	public partial class ProductsAboveAveragePriceTypedView : TypedViewBase<ProductsAboveAveragePriceRow>, ITypedView
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.ProductsAboveAveragePriceTypedView);
		}
		...
		{
			IEntityFields fieldsInResultset = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.ProductsAboveAveragePriceTypedView);
