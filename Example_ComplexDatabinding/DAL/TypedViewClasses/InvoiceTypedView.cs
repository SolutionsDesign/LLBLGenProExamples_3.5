...
namespace Northwind.DAL.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'Invoice'.<br/><br/></summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class InvoiceTypedView : TypedViewBase<InvoiceRow>, ITypedView
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static InvoiceTypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public InvoiceTypedView():base("Invoice")
		{
			InitClass();
		}
		...
		protected InvoiceTypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
			InitMembers();
		}
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.InvoiceTypedView);
		}
		...
		{
			IEntityFields fieldsInResultset = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.InvoiceTypedView);
		...
		{
			return new InvoiceRow(rowBuilder);
		}
		...
		{
			InvoiceTypedView cloneToReturn = ((InvoiceTypedView)(base.Clone()));
		...
		{
			get { return InvoiceTypedView.CustomProperties;}
		}
		...
		{
			get { return InvoiceTypedView.FieldsCustomProperties;}
		}
	...
	/// <summary>Typed datarow for the typed datatable Invoice</summary>
	public partial class InvoiceRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private InvoiceTypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal InvoiceRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((InvoiceTypedView)(this.Table));
		}
