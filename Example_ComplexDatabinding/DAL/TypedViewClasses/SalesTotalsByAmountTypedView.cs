...
namespace Northwind.DAL.TypedViewClasses
{
	...
	public partial class SalesTotalsByAmountTypedView : TypedViewBase<SalesTotalsByAmountRow>, ITypedView
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.SalesTotalsByAmountTypedView);
		}
		...
		{
			IEntityFields fieldsInResultset = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.SalesTotalsByAmountTypedView);
