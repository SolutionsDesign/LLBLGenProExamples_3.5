...
namespace Northwind.DAL.TypedViewClasses
{
	...
	public partial class SummaryOfSalesByQuarterTypedView : TypedViewBase<SummaryOfSalesByQuarterRow>, ITypedView
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.SummaryOfSalesByQuarterTypedView);
		}
		...
		{
			IEntityFields fieldsInResultset = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.SummaryOfSalesByQuarterTypedView);
