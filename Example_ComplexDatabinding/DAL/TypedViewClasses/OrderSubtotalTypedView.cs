...
namespace Northwind.DAL.TypedViewClasses
{
	...
	public partial class OrderSubtotalTypedView : TypedViewBase<OrderSubtotalRow>, ITypedView
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.OrderSubtotalTypedView);
		}
		...
		{
			IEntityFields fieldsInResultset = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.OrderSubtotalTypedView);
