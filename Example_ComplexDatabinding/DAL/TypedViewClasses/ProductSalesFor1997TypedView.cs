...
namespace Northwind.DAL.TypedViewClasses
{
	...
	public partial class ProductSalesFor1997TypedView : TypedViewBase<ProductSalesFor1997Row>, ITypedView
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.ProductSalesFor1997TypedView);
		}
