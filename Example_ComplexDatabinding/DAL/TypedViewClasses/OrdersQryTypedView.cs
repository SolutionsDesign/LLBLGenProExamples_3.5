...
namespace Northwind.DAL.TypedViewClasses
{
	...
	public partial class OrdersQryTypedView : TypedViewBase<OrdersQryRow>, ITypedView
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			return EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.OrdersQryTypedView);
		}
		...
		{
			IEntityFields fieldsInResultset = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.OrdersQryTypedView);
