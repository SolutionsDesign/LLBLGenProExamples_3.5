...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		{
			get { return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.ProductCollection(), (IEntityRelation)GetRelationsForField("Products")[0], (int)Northwind.DAL.EntityType.SupplierEntity, (int)Northwind.DAL.EntityType.ProductEntity, 0, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
