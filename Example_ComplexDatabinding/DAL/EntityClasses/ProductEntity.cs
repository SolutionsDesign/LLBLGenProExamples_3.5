		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncCategory(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _category, new PropertyChangedEventHandler( OnCategoryPropertyChanged ), "Category", Northwind.DAL.RelationClasses.StaticProductRelations.CategoryEntityUsingCategoryIdStatic, true, ref _alreadyFetchedCategory, new string[] {  } );
			}
		}
		...
		private void SetupSyncSupplier(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _supplier, new PropertyChangedEventHandler( OnSupplierPropertyChanged ), "Supplier", Northwind.DAL.RelationClasses.StaticProductRelations.SupplierEntityUsingSupplierIdStatic, true, ref _alreadyFetchedSupplier, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.CategoryCollection(), (IEntityRelation)GetRelationsForField("Category")[0], (int)Northwind.DAL.EntityType.ProductEntity, (int)Northwind.DAL.EntityType.CategoryEntity, 0, null, null, null, "Category", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.SupplierCollection(), (IEntityRelation)GetRelationsForField("Supplier")[0], (int)Northwind.DAL.EntityType.ProductEntity, (int)Northwind.DAL.EntityType.SupplierEntity, 0, null, null, null, "Supplier", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
