...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private Northwind.DAL.CollectionClasses.TerritoryCollection	_territories;
		...
		{
			_territories = (Northwind.DAL.CollectionClasses.TerritoryCollection)info.GetValue("_territories", typeof(Northwind.DAL.CollectionClasses.TerritoryCollection));
		...
		public Northwind.DAL.CollectionClasses.TerritoryCollection GetMultiTerritories(bool forceFetch)
		{
		...
		/// <returns>Filled collection with all related entities of type 'TerritoryEntity'</returns>
		public Northwind.DAL.CollectionClasses.TerritoryCollection GetMultiTerritories(bool forceFetch, IPredicateExpression filter)
		{
		...
		public Northwind.DAL.CollectionClasses.TerritoryCollection GetMultiTerritories(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public virtual Northwind.DAL.CollectionClasses.TerritoryCollection GetMultiTerritories(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
		...
		private void InitClassMembers()
		{
			...
			_territories = new Northwind.DAL.CollectionClasses.TerritoryCollection();
		...
		{
			get { return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.TerritoryCollection(), (IEntityRelation)GetRelationsForField("Territories")[0], (int)Northwind.DAL.EntityType.RegionEntity, (int)Northwind.DAL.EntityType.TerritoryEntity, 0, null, null, null, "Territories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		public virtual Northwind.DAL.CollectionClasses.TerritoryCollection Territories
		{
