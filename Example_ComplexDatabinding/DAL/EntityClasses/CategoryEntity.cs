...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private Northwind.DAL.CollectionClasses.ProductCollection	_products;
		...
		{
			_products = (Northwind.DAL.CollectionClasses.ProductCollection)info.GetValue("_products", typeof(Northwind.DAL.CollectionClasses.ProductCollection));
		...
		public Northwind.DAL.CollectionClasses.ProductCollection GetMultiProducts(bool forceFetch)
		{
		...
		/// <returns>Filled collection with all related entities of type 'ProductEntity'</returns>
		public Northwind.DAL.CollectionClasses.ProductCollection GetMultiProducts(bool forceFetch, IPredicateExpression filter)
		{
		...
		public Northwind.DAL.CollectionClasses.ProductCollection GetMultiProducts(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
		...
		/// <param name="filter">Extra filter to limit the resultset.</param>
		/// <returns>Filled collection with all related entities of the type constructed by the passed in entity factory</returns>
		public virtual Northwind.DAL.CollectionClasses.ProductCollection GetMultiProducts(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
		...
		private void InitClassMembers()
		{
			...
			_products = new Northwind.DAL.CollectionClasses.ProductCollection();
		...
		{
			get { return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.ProductCollection(), (IEntityRelation)GetRelationsForField("Products")[0], (int)Northwind.DAL.EntityType.CategoryEntity, (int)Northwind.DAL.EntityType.ProductEntity, 0, null, null, null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		public virtual Northwind.DAL.CollectionClasses.ProductCollection Products
		{
