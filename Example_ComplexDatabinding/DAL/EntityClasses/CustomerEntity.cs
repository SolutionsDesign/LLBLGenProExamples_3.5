...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private Northwind.DAL.CollectionClasses.CustomerCustomerDemoCollection	_customerCustomerDemos;
		...
		{
			_customerCustomerDemos = (Northwind.DAL.CollectionClasses.CustomerCustomerDemoCollection)info.GetValue("_customerCustomerDemos", typeof(Northwind.DAL.CollectionClasses.CustomerCustomerDemoCollection));
		...
		public Northwind.DAL.CollectionClasses.CustomerCustomerDemoCollection GetMultiCustomerCustomerDemos(bool forceFetch)
		{
		...
		public Northwind.DAL.CollectionClasses.CustomerCustomerDemoCollection GetMultiCustomerCustomerDemos(bool forceFetch, IEntityFactory entityFactoryToUse)
		{
		...
		private void InitClassMembers()
		{
			...
			_customerCustomerDemos = new Northwind.DAL.CollectionClasses.CustomerCustomerDemoCollection();
		...
		{
			get { return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.CustomerCustomerDemoCollection(), (IEntityRelation)GetRelationsForField("CustomerCustomerDemos")[0], (int)Northwind.DAL.EntityType.CustomerEntity, (int)Northwind.DAL.EntityType.CustomerCustomerDemoEntity, 0, null, null, null, "CustomerCustomerDemos", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		{
			get { return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.OrderCollection(), (IEntityRelation)GetRelationsForField("Orders")[0], (int)Northwind.DAL.EntityType.CustomerEntity, (int)Northwind.DAL.EntityType.OrderEntity, 0, null, null, null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		public virtual Northwind.DAL.CollectionClasses.CustomerCustomerDemoCollection CustomerCustomerDemos
		{
