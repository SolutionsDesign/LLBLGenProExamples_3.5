		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncOrder(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _order, new PropertyChangedEventHandler( OnOrderPropertyChanged ), "Order", Northwind.DAL.RelationClasses.StaticOrderDetailRelations.OrderEntityUsingOrderIdStatic, true, ref _alreadyFetchedOrder, new string[] {  } );
			}
		}
		...
		private void SetupSyncProduct(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _product, new PropertyChangedEventHandler( OnProductPropertyChanged ), "Product", Northwind.DAL.RelationClasses.StaticOrderDetailRelations.ProductEntityUsingProductIdStatic, true, ref _alreadyFetchedProduct, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.OrderCollection(), (IEntityRelation)GetRelationsForField("Order")[0], (int)Northwind.DAL.EntityType.OrderDetailEntity, (int)Northwind.DAL.EntityType.OrderEntity, 0, null, null, null, "Order", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new Northwind.DAL.CollectionClasses.ProductCollection(), (IEntityRelation)GetRelationsForField("Product")[0], (int)Northwind.DAL.EntityType.OrderDetailEntity, (int)Northwind.DAL.EntityType.ProductEntity, 0, null, null, null, "Product", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
