...
namespace Northwind.DAL.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the CustomerDemographics entity</summary>
		public EntityQuery<CustomerDemographicsEntity> CustomerDemographics
		{
			get { return Create<CustomerDemographicsEntity>(); }
		}
		...
		/// <summary>Creates and returns a new EntityQuery for the EmployeeTerritories entity</summary>
		public EntityQuery<EmployeeTerritoriesEntity> EmployeeTerritories
		{
			get { return Create<EmployeeTerritoriesEntity>(); }
		}
