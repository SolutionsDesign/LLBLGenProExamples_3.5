...
namespace Northwind.DAL.RelationClasses
{
	...
	public partial class TerritoryRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between TerritoryEntity and EmployeeTerritoriesEntity over the 1:n relation they have, using the relation between the fields:
		/// Territory.TerritoryId - EmployeeTerritories.TerritoryId
		/// </summary>
	...
	{
		internal static readonly IEntityRelation EmployeeTerritoriesEntityUsingTerritoryIdStatic = new TerritoryRelations().EmployeeTerritoriesEntityUsingTerritoryId;
