...
namespace Northwind.DAL.RelationClasses
{
	...
	public partial class EmployeeRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between EmployeeEntity and EmployeeTerritoriesEntity over the 1:n relation they have, using the relation between the fields:
		/// Employee.EmployeeId - EmployeeTerritories.EmployeeId
		/// </summary>
	...
	internal static class StaticEmployeeRelations
	{
		...
		internal static readonly IEntityRelation EmployeeTerritoriesEntityUsingEmployeeIdStatic = new EmployeeRelations().EmployeeTerritoriesEntityUsingEmployeeId;
