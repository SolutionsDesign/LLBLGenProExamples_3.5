...
namespace Northwind.DAL.RelationClasses
{
	...
	public partial class CustomerCustomerDemoRelations
	{
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.CustomerDemographicsEntityUsingCustomerTypeId);
			return toReturn;
		}
		...
		/// <summary>Returns a new IEntityRelation object, between CustomerCustomerDemoEntity and CustomerDemographicsEntity over the m:1 relation they have, using the relation between the fields:
		/// CustomerCustomerDemo.CustomerTypeId - CustomerDemographics.CustomerTypeId
		/// </summary>
		public virtual IEntityRelation CustomerDemographicsEntityUsingCustomerTypeId
		{
			get
			{
				...
				relation.InheritanceInfoPkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("CustomerDemographicsEntity", false);
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("CustomerCustomerDemoEntity", true);
				return relation;
			}
		}
	...
	internal static class StaticCustomerCustomerDemoRelations
	{
		...
		internal static readonly IEntityRelation CustomerDemographicsEntityUsingCustomerTypeIdStatic = new CustomerCustomerDemoRelations().CustomerDemographicsEntityUsingCustomerTypeId;
