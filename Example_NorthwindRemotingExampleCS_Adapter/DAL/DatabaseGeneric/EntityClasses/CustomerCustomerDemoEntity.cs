...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private CustomerDemographicsEntity _customerDemographics;
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "CustomerDemographics":
					this.CustomerDemographics = (CustomerDemographicsEntity)entity;
					break;
				default:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "Customers":
					...
					break;
				case "CustomerDemographics":
					toReturn.Add(Relations.CustomerDemographicsEntityUsingCustomerTypeId);
					break;
				default:
					break;				
			}
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entity of type 'CustomerDemographics' to this entity.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoCustomerDemographics()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(CustomerDemographicsFields.CustomerTypeId, null, ComparisonOperator.Equal, this.CustomerTypeId));
			return bucket;
		}
		...
		private void SetupSyncCustomers(IEntityCore relatedEntity)
		{
			if(_customers!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _customers, new PropertyChangedEventHandler( OnCustomersPropertyChanged ), "Customers", Northwind.DAL.RelationClasses.StaticCustomerCustomerDemoRelations.CustomerEntityUsingCustomerIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))),	(IEntityRelation)GetRelationsForField("Customers")[0], (int)Northwind.DAL.EntityType.CustomerCustomerDemoEntity, (int)Northwind.DAL.EntityType.CustomerEntity, 0, null, null, null, null, "Customers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(CustomerDemographicsEntityFactory))),	(IEntityRelation)GetRelationsForField("CustomerDemographics")[0], (int)Northwind.DAL.EntityType.CustomerCustomerDemoEntity, (int)Northwind.DAL.EntityType.CustomerDemographicsEntity, 0, null, null, null, null, "CustomerDemographics", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> Gets / sets related entity of type 'CustomerDemographicsEntity' which has to be set using a fetch action earlier. If no related entity is set for this property, null is returned..<br/><br/></summary>
		[Browsable(true)]
		public virtual CustomerDemographicsEntity CustomerDemographics
		{
