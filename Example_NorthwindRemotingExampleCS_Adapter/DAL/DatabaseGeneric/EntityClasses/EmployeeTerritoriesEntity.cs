		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncEmployees(IEntityCore relatedEntity)
		{
			if(_employees!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _employees, new PropertyChangedEventHandler( OnEmployeesPropertyChanged ), "Employees", Northwind.DAL.RelationClasses.StaticEmployeeTerritoriesRelations.EmployeeEntityUsingEmployeeIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _territories, new PropertyChangedEventHandler( OnTerritoriesPropertyChanged ), "Territories", Northwind.DAL.RelationClasses.StaticEmployeeTerritoriesRelations.TerritoryEntityUsingTerritoryIdStatic, true, signalRelatedEntity, "EmployeeTerritories", resetFKFields, new int[] { (int)EmployeeTerritoriesFieldIndex.TerritoryId } );
			_territories = null;
		}
		...
		private void SetupSyncTerritories(IEntityCore relatedEntity)
		{
			if(_territories!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _territories, new PropertyChangedEventHandler( OnTerritoriesPropertyChanged ), "Territories", Northwind.DAL.RelationClasses.StaticEmployeeTerritoriesRelations.TerritoryEntityUsingTerritoryIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))),	(IEntityRelation)GetRelationsForField("Employees")[0], (int)Northwind.DAL.EntityType.EmployeeTerritoriesEntity, (int)Northwind.DAL.EntityType.EmployeeEntity, 0, null, null, null, null, "Employees", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(TerritoryEntityFactory))),	(IEntityRelation)GetRelationsForField("Territories")[0], (int)Northwind.DAL.EntityType.EmployeeTerritoriesEntity, (int)Northwind.DAL.EntityType.TerritoryEntity, 0, null, null, null, null, "Territories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)Northwind.DAL.EntityType.EmployeeTerritoriesEntity; }
		}
