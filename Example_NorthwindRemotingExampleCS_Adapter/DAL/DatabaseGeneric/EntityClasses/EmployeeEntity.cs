...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<EmployeeTerritoriesEntity> _employeeTerritories;
		private EntityCollection<OrderEntity> _orders;
		private EntityCollection<CustomerEntity> _customers;
		private EntityCollection<ShipperEntity> _shippers;
		...
		protected EmployeeEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_shippers = (EntityCollection<ShipperEntity>)info.GetValue("_shippers", typeof(EntityCollection<ShipperEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "EmployeeTerritories":
					this.EmployeeTerritories.Add((EmployeeTerritoriesEntity)entity);
					break;
				case "Orders":
				...
				case "Customers":
					...
					break;
				case "Shippers":
					this.Shippers.IsReadOnly = false;
					this.Shippers.Add((ShipperEntity)entity);
					this.Shippers.IsReadOnly = true;
					break;
				case "Territories":
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "ManagedEmployees":
					...
					break;
				case "EmployeeTerritories":
					toReturn.Add(Relations.EmployeeTerritoriesEntityUsingEmployeeId);
					break;
				case "Orders":
				...
				case "Shippers":
					...
					break;
				case "Territories":
					toReturn.Add(Relations.EmployeeTerritoriesEntityUsingEmployeeId, "EmployeeEntity__", "EmployeeTerritories_", JoinHint.None);
					toReturn.Add(EmployeeTerritoriesEntity.Relations.TerritoryEntityUsingTerritoryId, "EmployeeTerritories_", string.Empty, JoinHint.None);
					break;
				default:
					break;				
			}
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			switch(fieldName)
			{
				...
				case "ManagedEmployees":
					...
					break;
				case "EmployeeTerritories":
					this.EmployeeTerritories.Add((EmployeeTerritoriesEntity)relatedEntity);
					break;
				case "Orders":
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_shippers", ((_shippers!=null) && (_shippers.Count>0) && !this.MarkedForDeletion)?_shippers:null);
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entities of type 'EmployeeTerritories' to this entity.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoEmployeeTerritories()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EmployeeTerritoriesFields.EmployeeId, null, ComparisonOperator.Equal, this.EmployeeId));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("Shippers"));
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EmployeeFields.EmployeeId, null, ComparisonOperator.Equal, this.EmployeeId, "EmployeeEntity__"));
			return bucket;
		}
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._shippers);
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._shippers = (EntityCollection<ShipperEntity>) collectionsQueue.Dequeue();
		...
		protected override void CreateMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue, Queue<bool> requiredQueue) 
		{
			...
			collectionsQueue.Enqueue(requiredQueue.Dequeue() ? new EntityCollection<EmployeeTerritoriesEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeTerritoriesEntityFactory))) : null);
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), (IEntityRelation)GetRelationsForField("ManagedEmployees")[0], (int)Northwind.DAL.EntityType.EmployeeEntity, (int)Northwind.DAL.EntityType.EmployeeEntity, 0, null, null, null, null, "ManagedEmployees", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}

		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'EmployeeTerritories' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathEmployeeTerritories
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeTerritoriesEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeTerritoriesEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeTerritories")[0], (int)Northwind.DAL.EntityType.EmployeeEntity, (int)Northwind.DAL.EntityType.EmployeeTerritoriesEntity, 0, null, null, null, null, "EmployeeTerritories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCustomers
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CustomerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))), intermediateRelation,
					(int)Northwind.DAL.EntityType.EmployeeEntity, (int)Northwind.DAL.EntityType.CustomerEntity, 0, null, null, GetRelationsForField("Customers"), null, "Customers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShippers
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShipperEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShipperEntityFactory))), intermediateRelation,
					(int)Northwind.DAL.EntityType.EmployeeEntity, (int)Northwind.DAL.EntityType.ShipperEntity, 0, null, null, GetRelationsForField("Shippers"), null, "Shippers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathTerritories
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.EmployeeTerritoriesEntityUsingEmployeeId;
				intermediateRelation.SetAliases(string.Empty, "EmployeeTerritories_");
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'EmployeeTerritoriesEntity' which are related to this entity via a relation of type '1:n'. If the EntityCollection hasn't been fetched yet, the collection returned will be empty.<br/><br/></summary>
		[TypeContainedAttribute(typeof(EmployeeTerritoriesEntity))]
		public virtual EntityCollection<EmployeeTerritoriesEntity> EmployeeTerritories
		{
			get { return GetOrCreateEntityCollection<EmployeeTerritoriesEntity, EmployeeTerritoriesEntityFactory>("Employees", true, false, ref _employeeTerritories);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<CustomerEntity, CustomerEntityFactory>("Employees", false, true, ref _customers);	}
		}
		...
		public virtual EntityCollection<ShipperEntity> Shippers
		{
			get { return GetOrCreateEntityCollection<ShipperEntity, ShipperEntityFactory>("Employees", false, true, ref _shippers);	}
		}
