...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "OrderDetails":
					...
					break;
				case "Orders":
					this.Orders.IsReadOnly = false;
					this.Orders.Add((OrderEntity)entity);
					this.Orders.IsReadOnly = true;
					break;
				default:
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("Orders"));
		...
		public static IPrefetchPathElement2 PrefetchPathOrders
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<OrderEntity>(EntityFactoryCache2.GetEntityFactory(typeof(OrderEntityFactory))), intermediateRelation,
					(int)Northwind.DAL.EntityType.ProductEntity, (int)Northwind.DAL.EntityType.OrderEntity, 0, null, null, GetRelationsForField("Orders"), null, "Orders", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return GetOrCreateEntityCollection<OrderEntity, OrderEntityFactory>("Products", false, true, ref _orders);	}
		}
