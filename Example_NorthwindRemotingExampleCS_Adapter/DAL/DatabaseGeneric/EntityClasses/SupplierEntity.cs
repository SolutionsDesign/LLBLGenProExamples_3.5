...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<CategoryEntity> _category;
		...
		protected SupplierEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_category = (EntityCollection<CategoryEntity>)info.GetValue("_category", typeof(EntityCollection<CategoryEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				case "Products":
					...
					break;
				case "Category":
					this.Category.IsReadOnly = false;
					this.Category.Add((CategoryEntity)entity);
					this.Category.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_category", ((_category!=null) && (_category.Count>0) && !this.MarkedForDeletion)?_category:null);
			}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("Category"));
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._category);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._category = (EntityCollection<CategoryEntity>) collectionsQueue.Dequeue();
		...
		public static IPrefetchPathElement2 PrefetchPathCategory
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CategoryEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CategoryEntityFactory))), intermediateRelation,
					(int)Northwind.DAL.EntityType.SupplierEntity, (int)Northwind.DAL.EntityType.CategoryEntity, 0, null, null, GetRelationsForField("Category"), null, "Category", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public virtual EntityCollection<CategoryEntity> Category
		{
			get { return GetOrCreateEntityCollection<CategoryEntity, CategoryEntityFactory>("Suppliers", false, true, ref _category);	}
		}
