...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "OrderDetails":
					...
					break;
				case "Products":
					this.Products.IsReadOnly = false;
					this.Products.Add((ProductEntity)entity);
					this.Products.IsReadOnly = true;
					break;
				default:
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("Products"));
		...
		public static IPrefetchPathElement2 PrefetchPathProducts
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ProductEntityFactory))), intermediateRelation,
					(int)Northwind.DAL.EntityType.OrderEntity, (int)Northwind.DAL.EntityType.ProductEntity, 0, null, null, GetRelationsForField("Products"), null, "Products", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		{
			get { return GetOrCreateEntityCollection<ProductEntity, ProductEntityFactory>("Orders", false, true, ref _products);	}
		}
