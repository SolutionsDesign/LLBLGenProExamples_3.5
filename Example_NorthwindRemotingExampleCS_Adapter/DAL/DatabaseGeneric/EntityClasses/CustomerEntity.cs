...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<CustomerDemographicsEntity> _customerDemographics;
		...
		protected CustomerEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_customerDemographics = (EntityCollection<CustomerDemographicsEntity>)info.GetValue("_customerDemographics", typeof(EntityCollection<CustomerDemographicsEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				...
				case "CustomerDemographics":
					...
					this.CustomerDemographics.Add((CustomerDemographicsEntity)entity);
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				...
				case "CustomerDemographics":
					...
					toReturn.Add(CustomerCustomerDemoEntity.Relations.CustomerDemographicsEntityUsingCustomerTypeId, "CustomerCustomerDemo_", string.Empty, JoinHint.None);
					break;
				case "Employees":
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entities of type 'CustomerDemographics' to this entity.</summary>
		/// <returns></returns>
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._customerDemographics = (EntityCollection<CustomerDemographicsEntity>) collectionsQueue.Dequeue();
		...
		protected override void CreateMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue, Queue<bool> requiredQueue) 
		{
			...
			collectionsQueue.Enqueue(requiredQueue.Dequeue() ? new EntityCollection<CustomerDemographicsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerDemographicsEntityFactory))) : null);
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			fieldHashtable.Add("GuiElement", @"Textbox");
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'CustomerDemographics' for this entity.</summary>
		/// <returns>Ready to use IPrefetchPathElement2 implementation.</returns>
		public static IPrefetchPathElement2 PrefetchPathCustomerDemographics
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CustomerDemographicsEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerDemographicsEntityFactory))), intermediateRelation,
					(int)Northwind.DAL.EntityType.CustomerEntity, (int)Northwind.DAL.EntityType.CustomerDemographicsEntity, 0, null, null, GetRelationsForField("CustomerDemographics"), null, "CustomerDemographics", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmployees
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<EmployeeEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeEntityFactory))), intermediateRelation,
					(int)Northwind.DAL.EntityType.CustomerEntity, (int)Northwind.DAL.EntityType.EmployeeEntity, 0, null, null, GetRelationsForField("Employees"), null, "Employees", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathShippers
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<ShipperEntity>(EntityFactoryCache2.GetEntityFactory(typeof(ShipperEntityFactory))), intermediateRelation,
					(int)Northwind.DAL.EntityType.CustomerEntity, (int)Northwind.DAL.EntityType.ShipperEntity, 0, null, null, GetRelationsForField("Shippers"), null, "Shippers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'CustomerDemographicsEntity' which are related to this entity via a relation of type 'm:n'. If the EntityCollection hasn't been fetched yet, the collection returned will be empty.<br/><br/></summary>
		[TypeContainedAttribute(typeof(CustomerDemographicsEntity))]
		public virtual EntityCollection<CustomerDemographicsEntity> CustomerDemographics
		{
			get { return GetOrCreateEntityCollection<CustomerDemographicsEntity, CustomerDemographicsEntityFactory>("Customers", false, true, ref _customerDemographics);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<EmployeeEntity, EmployeeEntityFactory>("Customers", false, true, ref _employees);	}
		}
		...
		{
			get { return GetOrCreateEntityCollection<ShipperEntity, ShipperEntityFactory>("Customers", false, true, ref _shippers);	}
		}
