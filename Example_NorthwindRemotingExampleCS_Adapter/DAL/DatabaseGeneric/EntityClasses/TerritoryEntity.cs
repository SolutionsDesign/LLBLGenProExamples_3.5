...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "Region":
					...
					break;
				case "EmployeeTerritories":
					toReturn.Add(Relations.EmployeeTerritoriesEntityUsingTerritoryId);
					break;
				case "Employees":
					toReturn.Add(Relations.EmployeeTerritoriesEntityUsingTerritoryId, "TerritoryEntity__", "EmployeeTerritories_", JoinHint.None);
					toReturn.Add(EmployeeTerritoriesEntity.Relations.EmployeeEntityUsingEmployeeId, "EmployeeTerritories_", string.Empty, JoinHint.None);
					break;
				default:
					break;				
			}
		...
		public virtual IRelationPredicateBucket GetRelationInfoEmployeeTerritories()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(EmployeeTerritoriesFields.TerritoryId, null, ComparisonOperator.Equal, this.TerritoryId));
			return bucket;
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<EmployeeTerritoriesEntity>(EntityFactoryCache2.GetEntityFactory(typeof(EmployeeTerritoriesEntityFactory))), (IEntityRelation)GetRelationsForField("EmployeeTerritories")[0], (int)Northwind.DAL.EntityType.TerritoryEntity, (int)Northwind.DAL.EntityType.EmployeeTerritoriesEntity, 0, null, null, null, null, "EmployeeTerritories", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		public static IPrefetchPathElement2 PrefetchPathEmployees
		{
			get
			{
				IEntityRelation intermediateRelation = Relations.EmployeeTerritoriesEntityUsingTerritoryId;
		...
		{
			get { return GetOrCreateEntityCollection<EmployeeTerritoriesEntity, EmployeeTerritoriesEntityFactory>("Territories", true, false, ref _employeeTerritories);	}
		}
