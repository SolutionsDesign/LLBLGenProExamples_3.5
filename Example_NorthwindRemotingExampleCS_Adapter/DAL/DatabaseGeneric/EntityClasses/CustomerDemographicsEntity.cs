...
namespace Northwind.DAL.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'CustomerDemographics'.<br/><br/></summary>
	[Serializable]
	public partial class CustomerDemographicsEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static CustomerDemographicsEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public CustomerDemographicsEntity():base("CustomerDemographicsEntity")
		{
		...
		public CustomerDemographicsEntity(IEntityFields2 fields):base("CustomerDemographicsEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this CustomerDemographicsEntity</param>
		public CustomerDemographicsEntity(IValidator validator):base("CustomerDemographicsEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="customerTypeId">PK value for CustomerDemographics which data should be fetched into this CustomerDemographics object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CustomerDemographicsEntity(System.String customerTypeId):base("CustomerDemographicsEntity")
		{
			InitClassEmpty(null, null);
		...
		/// <param name="validator">The custom validator object for this CustomerDemographicsEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public CustomerDemographicsEntity(System.String customerTypeId, IValidator validator):base("CustomerDemographicsEntity")
		{
			InitClassEmpty(validator, null);
			this.CustomerTypeId = customerTypeId;
		}
		...
		protected CustomerDemographicsEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			switch(fieldName)
			{
				case "CustomerCustomerDemo":
					...
					break;
				case "Customers":
					toReturn.Add(Relations.CustomerCustomerDemoEntityUsingCustomerTypeId, "CustomerDemographicsEntity__", "CustomerCustomerDemo_", JoinHint.None);
		...
		{
			return new CustomerDemographicsRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoCustomers()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(CustomerDemographicsFields.CustomerTypeId, null, ComparisonOperator.Equal, this.CustomerTypeId, "CustomerDemographicsEntity__"));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(CustomerDemographicsEntityFactory));
		}
#if !CF
		...
		/// <param name="validator">The validator object for this CustomerDemographicsEntity</param>
		...
		public  static CustomerDemographicsRelations Relations
		{
			get	{ return new CustomerDemographicsRelations(); }
		}
		...
		public static IPrefetchPathElement2 PrefetchPathCustomers
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<CustomerEntity>(EntityFactoryCache2.GetEntityFactory(typeof(CustomerEntityFactory))), intermediateRelation,
					(int)Northwind.DAL.EntityType.CustomerDemographicsEntity, (int)Northwind.DAL.EntityType.CustomerEntity, 0, null, null, GetRelationsForField("Customers"), null, "Customers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		/// <summary> The CustomerDesc property of the Entity CustomerDemographics<br/><br/></summary>
		...
		{
			get { return (System.String)GetValue((int)CustomerDemographicsFieldIndex.CustomerDesc, true); }
			set	{ SetValue((int)CustomerDemographicsFieldIndex.CustomerDesc, value); }
		}

		/// <summary> The CustomerTypeId property of the Entity CustomerDemographics<br/><br/></summary>
		...
		{
			get { return (System.String)GetValue((int)CustomerDemographicsFieldIndex.CustomerTypeId, true); }
			set	{ SetValue((int)CustomerDemographicsFieldIndex.CustomerTypeId, value); }
		}
		...
		{ 
			get { return (int)Northwind.DAL.EntityType.CustomerDemographicsEntity; }
		}
