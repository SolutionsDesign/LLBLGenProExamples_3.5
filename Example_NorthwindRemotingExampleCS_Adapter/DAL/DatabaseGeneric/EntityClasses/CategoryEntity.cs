...
namespace Northwind.DAL.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private EntityCollection<SupplierEntity> _suppliers;
		...
		protected CategoryEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			if(SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				_suppliers = (EntityCollection<SupplierEntity>)info.GetValue("_suppliers", typeof(EntityCollection<SupplierEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				case "Products":
					...
					break;
				case "Suppliers":
					this.Suppliers.IsReadOnly = false;
					this.Suppliers.Add((SupplierEntity)entity);
					this.Suppliers.IsReadOnly = true;
					break;
				default:
		...
		protected override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			if (SerializationHelper.Optimization != SerializationOptimization.Fast) 
			{
				...
				info.AddValue("_suppliers", ((_suppliers!=null) && (_suppliers.Count>0) && !this.MarkedForDeletion)?_suppliers:null);
			}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.Relations.AddRange(GetRelationsForFieldOfType("Suppliers"));
		...
		protected override void AddToMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue) 
		{
			...
			collectionsQueue.Enqueue(this._suppliers);
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._suppliers = (EntityCollection<SupplierEntity>) collectionsQueue.Dequeue();
		...
		public static IPrefetchPathElement2 PrefetchPathSuppliers
		{
			get
			{
				...
				return new PrefetchPathElement2(new EntityCollection<SupplierEntity>(EntityFactoryCache2.GetEntityFactory(typeof(SupplierEntityFactory))), intermediateRelation,
					(int)Northwind.DAL.EntityType.CategoryEntity, (int)Northwind.DAL.EntityType.SupplierEntity, 0, null, null, GetRelationsForField("Suppliers"), null, "Suppliers", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToMany);
			}
		}
		...
		public virtual EntityCollection<SupplierEntity> Suppliers
		{
			get { return GetOrCreateEntityCollection<SupplierEntity, SupplierEntityFactory>("Category", false, true, ref _suppliers);	}
		}
