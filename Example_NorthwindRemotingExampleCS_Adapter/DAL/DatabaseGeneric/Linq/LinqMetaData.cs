...
namespace Northwind.DAL.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		public IDataSource GetQueryableForEntity(int typeOfEntity)
		{
			...
			switch((Northwind.DAL.EntityType)typeOfEntity)
			{
				...
				case Northwind.DAL.EntityType.CustomerCustomerDemoEntity:
					...
					break;
				case Northwind.DAL.EntityType.CustomerDemographicsEntity:
					toReturn = this.CustomerDemographics;
					break;
				case Northwind.DAL.EntityType.EmployeeEntity:
					toReturn = this.Employee;
					break;
				case Northwind.DAL.EntityType.EmployeeTerritoriesEntity:
					toReturn = this.EmployeeTerritories;
					break;
				case Northwind.DAL.EntityType.OrderEntity:
					toReturn = this.Order;
					break;
				case Northwind.DAL.EntityType.OrderDetailsEntity:
		...
		/// <summary>returns the datasource to use in a Linq query when targeting CustomerDemographicsEntity instances in the database.</summary>
		public DataSource2<CustomerDemographicsEntity> CustomerDemographics
		{
			get { return new DataSource2<CustomerDemographicsEntity>(_adapterToUse, new ElementCreator(), _customFunctionMappings, _contextToUse); }
		}
		...
		/// <summary>returns the datasource to use in a Linq query when targeting EmployeeTerritoriesEntity instances in the database.</summary>
		public DataSource2<EmployeeTerritoriesEntity> EmployeeTerritories
		{
			get { return new DataSource2<EmployeeTerritoriesEntity>(_adapterToUse, new ElementCreator(), _customFunctionMappings, _contextToUse); }
		}
