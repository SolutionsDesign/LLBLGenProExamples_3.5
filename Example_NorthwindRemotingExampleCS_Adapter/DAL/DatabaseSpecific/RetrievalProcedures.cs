...
namespace Northwind.DAL.DatabaseSpecific
{
	...
	public static partial class RetrievalProcedures
	{
		...
		/// <returns>Filled DataTable with resultset(s) of stored procedure</returns>
		public static DataTable SalesByCategory(System.String categoryName, System.String ordYear)
		{
			using(DataAccessAdapter dataAccessProvider = new DataAccessAdapter())
			{
				return SalesByCategory(categoryName, ordYear, dataAccessProvider);
			}
		}
		...
		/// <param name="ordYear">Input parameter. </param>
		/// <returns>Filled DataTable with resultset(s) of stored procedure</returns>
		public static DataTable SalesByCategory(System.String categoryName, System.String ordYear, IDataAccessCore dataAccessProvider)
		{
			using(StoredProcedureCall call = CreateSalesByCategoryCall(dataAccessProvider, categoryName, ordYear))
			{
				DataTable toReturn = call.FillDataTable();
				return toReturn;
			}
		...
		/// <returns>IRetrievalQuery object which is ready to use for datafetching</returns>
		public static IRetrievalQuery GetSalesByCategoryCallAsQuery(System.String categoryName, System.String ordYear)
		{
			using(DataAccessAdapter dataAccessProvider = new DataAccessAdapter())
			{
				return CreateSalesByCategoryCall(dataAccessProvider, categoryName, ordYear).ToRetrievalQuery();
			}
		}
		...
		private static StoredProcedureCall CreateCustOrdersDetailCall(IDataAccessCore dataAccessProvider, System.Int32 orderId)
		{
			return new StoredProcedureCall(dataAccessProvider, @"[Northwind].[dbo].[CustOrdersDetail]", "CustOrdersDetail")
							.AddParameter("@OrderID", "Int", 0, ParameterDirection.Input, true, 0, 0, orderId);
		}
		...
		/// <summary>Creates the call object for the call 'SalesByCategory' to stored procedure 'SalesByCategory'.</summary>
		/// <param name="dataAccessProvider">The data access provider.</param>
		/// <param name="categoryName">Input parameter</param>
		/// <param name="ordYear">Input parameter</param>
		/// <returns>Ready to use StoredProcedureCall object</returns>
		private static StoredProcedureCall CreateSalesByCategoryCall(IDataAccessCore dataAccessProvider, System.String categoryName, System.String ordYear)
		{
			return new StoredProcedureCall(dataAccessProvider, @"[Northwind].[dbo].[SalesByCategory]", "SalesByCategory")
