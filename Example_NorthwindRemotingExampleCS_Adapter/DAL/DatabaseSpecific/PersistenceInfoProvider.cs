...
namespace Northwind.DAL.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void Init()
		{
			...
			InitCustomerDemographicsEntityMappings();
			InitEmployeeEntityMappings();
			InitEmployeeTerritoriesEntityMappings();
		...
		/// <summary>Inits CustomerDemographicsEntity's mappings</summary>
		private void InitCustomerDemographicsEntityMappings()
		{
			this.AddElementMapping( "CustomerDemographicsEntity", @"Northwind", @"dbo", "CustomerDemographics", 2 );
			this.AddElementFieldMapping( "CustomerDemographicsEntity", "CustomerDesc", "CustomerDesc", true, "NText", 1073741823, 0, 0, false, "", null, typeof(System.String), 0 );
			this.AddElementFieldMapping( "CustomerDemographicsEntity", "CustomerTypeId", "CustomerTypeID", false, "NChar", 10, 0, 0, false, "", null, typeof(System.String), 1 );
		}
		...
		/// <summary>Inits EmployeeTerritoriesEntity's mappings</summary>
		private void InitEmployeeTerritoriesEntityMappings()
		{
			this.AddElementMapping( "EmployeeTerritoriesEntity", @"Northwind", @"dbo", "EmployeeTerritories", 2 );
			this.AddElementFieldMapping( "EmployeeTerritoriesEntity", "EmployeeId", "EmployeeID", false, "Int", 0, 0, 10, false, "", null, typeof(System.Int32), 0 );
			this.AddElementFieldMapping( "EmployeeTerritoriesEntity", "TerritoryId", "TerritoryID", false, "NVarChar", 20, 0, 0, false, "", null, typeof(System.String), 1 );
		}
